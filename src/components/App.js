...
export default {
  template: `<div :class="['main', { 'update' : update_check }]">
								...
								<book-viewer v-show="! toggleBooksContent" :src="openedBookPath" :listId="openedBooklistId" :bookId="openedBookId"></book-viewer>
  ...
  computed: {
    ...mapGetters({
      ...
      openedBooklistId: "openedBooklistId",
  ...
  created() {
    ...
    try {
      request.get(
        "https://api.github.com/repos/oguzhaninan/Buka/releases/latest",
        {
          headers: {
